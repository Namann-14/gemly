        ...
        <div className="md:col-span-6 flex flex-col gap-4">
          ...
          >
            ...
            <motion.img
              ...
              src={getCdnUrl(gem.images[activeImgIdx])}
              alt={gem.name}
          ...
          <div className="flex gap-3 mt-1 justify-center">
            {gem.images.map((img, idx) => (
              <button
                ...
                className={`w-20 h-20 rounded-xl overflow-hidden border bg-[#0d0a1b] p-1 transition-all duration-300 cursor-pointer ${activeImgIdx === idx
              ...
              >
                <img src={getCdnUrl(img)} alt={`${gem.name} ${idx + 1}`} className="w-full h-full object-contain" />
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="md:col-span-6 flex flex-col gap-6">
              ...
              {rattiSizes.map((size) => {
                ...
                return (
                  <button
                    ...
                    className={`min-w-[54px] px-3.5 py-2.5 rounded-lg border text-xs font-light tracking-wide transition-all duration-200 cursor-pointer ${active
          ...
          <div className="flex flex-col sm:flex-row gap-3.5 mt-2">
            <Button
              ...
              onClick={() => {
                addItem({
                  id: `${gem.name}-${selectedRatti}`,
                  name: gem.name,
                  ratti: selectedRatti,
                  quantity: quantity,
                  pricePerRatti: gem.basePricePerRatti,
                  image: getCdnUrl(gem.images[0]),
                  planet: gem.planet,
                  color: gem.color
                });
              }}
              className="flex-1 rounded-xl border-purple-500/20 bg-transparent text-[#f8f8ff] hover:bg-purple-500/10 hover:border-purple-500/65 py-6 text-xs md:text-sm font-medium transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <Button
              ...
              className="flex-1 rounded-xl bg-rose-950/80 hover:bg-rose-900 border border-rose-500/30 text-rose-200 py-6 text-xs md:text-sm font-medium transition-all shadow-[0_0_20px_rgba(244,63,94,0.08)] cursor-pointer"
            >
              Buy it now
            </Button>
          </div>
